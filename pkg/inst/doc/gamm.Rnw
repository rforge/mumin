...
gamm4 <- 
    function(...) 
    structure(c(gamm4::gamm4(...), list(call=match.call())), class=c("gamm", "list"))
@
...
<<>>=
dat <- gamSim(6,n=100,scale=.2,dist="gaussian")
...
<<>>=
fmgs1 <- gamm4(y ~ x0+ s(x1, k=3, fx=TRUE)+ x2+ x3, family=poisson, data=dat,random=~ (1|fac))
